...
export const GUACAMOLE_STATUS = {
    ...
    515: {
        ...
        'In most cases, the upstream server is the remote desktop server.'
    },
    516: {
    ...
    769: {
        ...
        text: 'Permission was denied, because the user is not logged in.' + 
        'Note that the user may be logged into Guacamole,' + 
        'but still not logged in with respect to the remote desktop server.'
    },
    771: {
    ...
    797: {
        ...
        text: 'The client is already using too many resources.' + 
        'Existing resources must be freed before further requests are allowed.'
    },
