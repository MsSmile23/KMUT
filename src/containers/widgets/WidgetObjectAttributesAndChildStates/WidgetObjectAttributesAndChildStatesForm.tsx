...
interface WidgetObjectAttributesAndChildStatesFormProps {
...
const WidgetObjectAttributesAndChildStatesForm: FC<WidgetObjectAttributesAndChildStatesFormProps> = (props) => {
...
export default WidgetObjectAttributesAndChildStatesForm