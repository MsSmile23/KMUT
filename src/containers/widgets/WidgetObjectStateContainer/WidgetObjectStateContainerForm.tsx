...
interface WidgetObjectStateContainerFormProps {
...
const WidgetObjectStateContainerForm: FC<WidgetObjectStateContainerFormProps> = (props) => {
...
export default WidgetObjectStateContainerForm