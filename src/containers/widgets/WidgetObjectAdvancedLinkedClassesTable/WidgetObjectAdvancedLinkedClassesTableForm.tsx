...
interface WidgetObjectAdvancedLinkedClassesTableFormProps {
...
const WidgetObjectAdvancedLinkedClassesTableForm: FC<WidgetObjectAdvancedLinkedClassesTableFormProps> = (props) => {
...
export default WidgetObjectAdvancedLinkedClassesTableForm