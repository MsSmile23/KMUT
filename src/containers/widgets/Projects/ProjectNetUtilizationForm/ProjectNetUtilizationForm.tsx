...
interface IProjectNetUtilizationFormFormProps {
...
const ProjectNetUtilizationFormForm = (props: IProjectNetUtilizationFormFormProps) => {
...
export default ProjectNetUtilizationFormForm