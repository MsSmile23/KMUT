    ...
    Client.prototype = {
        install: function() {
            ...
            this.canvas.addEventListener('mousedown', function(e) {
                ...
                var offset = Mstsc.elementOffset(self.canvas);
                self.socket
                    .emit('mouse', e.clientX - offset.left, e.clientY - offset.top, mouseButtonMap(e.button), true);
                e.preventDefault();
            ...
            this.canvas.addEventListener('mouseup', function(e) {
                ...
                var offset = Mstsc.elementOffset(self.canvas);
                self.socket
                    .emit('mouse', e.clientX - offset.left, e.clientY - offset.top, mouseButtonMap(e.button), false);
                e.preventDefault();
            ...
            this.canvas.addEventListener('DOMMouseScroll', function(e) {
                ...
                var offset = Mstsc.elementOffset(self.canvas);
                self.socket
                    .emit('wheel', e.clientX - offset.left, e.clientY - offset.top, step, delta > 0, isHorizontal);
                e.preventDefault();
		 ...
		 */
        connect: function(ip, domain, username, password, host, next) {
            ...
            // start connection
            var self = this;
            this.socket = io('ws://192.168.1.171:8080', { path: '/socket.io/' })
