...
const MarkoTestTanTankTableBackUp: FC = ({ data, columns, currentTheme }) => {
                        ...
                        {table.getHeaderGroups().map((headerGroup) => (
                            <tr key={headerGroup.id}>
                                {headerGroup.headers.map((header) => (
                                    <th key={header.id} style={{ width: header.getSize(), height: '80px' }}>
...
// export default MarkoTestTanTankTableBackUp
