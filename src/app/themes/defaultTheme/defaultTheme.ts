...
type ILocalTheme = Partial<ITheme<IThemeComponentMnemo.tables | IThemeComponentMnemo.map | IThemeComponentMnemo.tree>>

const localTheme: any /*ILocalTheme*/ = {
...
const defaultTheme = mergeTheme(commonTheme, localTheme) as IProjectSettings & ILocalTheme
